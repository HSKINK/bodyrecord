class FatsController < ApplicationController
  ...
  def fat_params
    params.require(:fat_body).permit(:weight, :body_fat, :day, :sex_id, :age, :height, :nutrients_p, :nutrients_f, :nutrients_c, :goal_body_fat, :fat_id ).merge(user_id: current_user.id)
  end
end
