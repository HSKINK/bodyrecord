class FatBody
  ...
  with_options format: { with: /\A[0-9]+\z/ } do
    ...
    validates :nutrients_p, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }
    validates :nutrients_f, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }
    validates :nutrients_c, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }
  end
